...
<span>สวัสดีพวกเราได้โพสคำถามเกี่ยวกับ Javascript เอาไว้ใน [Instagram](https://www.instagram.com/theavocoder) **stories**, และก็จะโพสเอาไว้ใน Github page ด้วย! Last updated: <a href=#20191224><b>24 ธันวาคม</b></a>

คำถามประกอบไปด้วยตั้งแต่ระดับเริ่มต้น ถึง ระดับขั้นสูง: จุดประสงค์เพื่อให้รู้ว่าเรารู้เกี่ยวกับ Javascript มากน้อยขนาดไหน ทบทวนความรู้ เตรียมตัวสำหรับการสัมภาษณ์ :muscle: :rocket: Reposentory นี้มีการ Update อย่างสม่ำเสมอกรณีที่มีคำถามใหม่ๆเข้ามา เราได้ใส่คำตอบเอาไว้ในส่วนที่ซ่อนอยู่ **collapsed sections** ข้างใต้คำถามอย่าลืมคลิกมันนะมันจะขยายออก โชคดีจ้า :heart:</span>
