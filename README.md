...
This is because you defined a new method called giveLydiaPizza on String.prototype, but you tried to call this method on a string literal name. String literals are not automatically converted to String objects, so they do not inherit any methods from String.prototype.
