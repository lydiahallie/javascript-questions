...
fs.readFile(`es-ES.txt`, 'utf8', (err, data) => {
  if (err) throw err;
  ...
  fs.writeFile(`es-ES.json`, questionJSON, 'utf8', (err)=>{
      if(err) throw err;
      console.log('success!!')
  });

  //test sequence
    // const testData = dataArr[0];
    // const qObj = getQuestionObj(testData, 1);
...
function getQuestionText(questionData){
    ...
    const questionLine = questionData.match(regex)[0];
